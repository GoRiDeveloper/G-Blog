...
// Ruta para registro, con middleware para validar un fichero de imagen de usuario, el cuerpo del registro de usuario y controlador para generar ese usuario con su token.
authRouter.post(
  "/sign-up",
...
// Ruta para iniciar sesión, con middleware para validar el cuerpo de los datos de inicio de sesión y controlador para generar tu token.
authRouter.post(
  "/sign-in",
