export const MailSVG = (props: any): JSX.Element => {
    return (
        <svg {...props}>
...
export const LoaderSVG = (props: any): JSX.Element => {
    return (
        <svg {...props}>
...
export const LockSVG = (props: any): JSX.Element => {
    return (
        <svg {...props}>
...
export const UserIdSVG = (props: any): JSX.Element => {
    return (
        <svg {...props}>
...
export const MessageSVG = (props: any): JSX.Element => {
    return (
        <svg {...props}>
